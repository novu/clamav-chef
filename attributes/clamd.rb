...
default['clamav']['clamd']['scan_onaccess'] = nil
default['clamav']['clamd']['onaccess_mount_paths'] = []
default['clamav']['clamd']['onaccess_max_file_size'] = nil
default['clamav']['clamd']['onaccess_include_paths'] = []
default['clamav']['clamd']['onaccess_exclude_paths'] = []
default['clamav']['clamd']['onaccess_exclude_uids'] = []
default['clamav']['clamd']['onaccess_disable_ddd'] = nil
default['clamav']['clamd']['onaccess_prevention'] = nil
default['clamav']['clamd']['onaccess_extra_scanning'] = nil
